...
# Dependency to get current user (temporarily disabled to fix Railway deployment)
# TODO: Implement proper Supabase-based authentication
async def get_current_user():
    """Placeholder - using browser-based auth for now"""
    return {"id": "temp-user", "email": "temp@example.com"}
...
# New beta testing endpoints (temporarily disabled for Railway deployment)
